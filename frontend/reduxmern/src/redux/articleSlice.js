...
export const addarticleid = createAsyncThunk(
  "article/addArticleid",
  (id, thunkAPI) => {
    try {
...
export const updatearticle = createAsyncThunk(
  ...
  async (userData, ArticleId, thunkAPI) => {
    try {
    ...
    builder
      ...
      .addCase(updatearticle.fulfilled, (state, action) => {
        ...
        state.Articles = state.Articles.map((item) =>
          item._id === state.ArticleId ? action.payload : ""
        );
      })
      ...
      .addCase(likearticle.fulfilled, (state, action) => {
        state.isSuccess = true;
        state.Articles = state.Articles.map((item) =>
          item._id === action.payload._id ? action.payload : null
        );
      })
